...
namespace ARBot.Common.Algorithms.Voronoi
{
	...
	public class VoronoiDiagram
	{
		...
		// constructor
		public VoronoiDiagram( double minDistanceBetweenSites, double presah )
		{
			siteidx = 0;
			sites = null;
        ...
        public List<GraphEdge> generateVoronoi(List<Site> ss)
        {
            sort(ss);
        ...
        private void sort(List<Site> ss)
        {
            sites = null;
		...
		private void qsort ( List<Site> sites )
		{
            sites.Sort(new SiteSorterYX());
           
		}

        public static Rectangle Border(List<Site> ss)
        {
            double xmin = ss[0].coord.X;
            double ymin = ss[0].coord.Y;
            double xmax = ss[0].coord.X;
            double ymax = ss[0].coord.Y;
        ...
        private void sortNode(List<Site> ss)
        {
            nsites = ss.Count;
            sites = ss;
            ...
            xmin = b.X;
            ymin = b.Y;
            xmax = b.RightBottom.X;
            ymax = b.RightBottom.Y;

            borderMinX = xmin-presah;
            borderMinY = ymin - presah;
            borderMaxX = xmax+presah;
            borderMaxY = ymax + presah;
		...
		private bool right_of(Halfedge el, Point2D p)
		{
			Edge e;
			Site topsite;
			bool right_of_site;
