...
{
    public class EKFModel3Measurement : Matrix
    {
        public EKFModel3Measurement()
            : base(13, 1)
        {
        }

        /// <summary>
        /// Orientace comapsu v radianech a matematickem smyslu
        /// </summary>
        ...
        /// <param name="b"></param>
        /// <returns></returns>
        public static Matrix operator -(EKFModel3Measurement a, EKFModel3Measurement b)
        {
            EKFModel3Measurement x=new EKFModel3Measurement();
